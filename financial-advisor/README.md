...
3.  **Configuration**
    ...
    *   Set up Google Cloud credentials.
        ...
        *   You may set the following environment variables in your shell, or in
        ...
        export GOOGLE_CLOUD_PROJECT=stocks538
        export GOOGLE_CLOUD_LOCATION=us-east-1
        export GOOGLE_CLOUD_STORAGE_BUCKET=   # Only required for deployment on Agent Engine
        ```
