...
Agent generated with [`googleCloudPlatform/agent-starter-pack`](https://github.com/GoogleCloudPlatform/agent-starter-pack) version `0.22.1`
...
```
financial-advisor/
├── financial_advisor/                 # Core application code
...
2. **Integrate:** Import your agent into the app by editing `financial_advisor/agent.py`.
