...
@click.option(
    "--description",
    default="AI-driven agent designed to facilitate the exploration of the financial advisor landscape",
...
@click.option(
    "--entrypoint-module",
    default="financial_advisor.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="financial_advisor/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to financial_advisor/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
...
def deploy_agent_engine_app(
    ...
    labels_dict["vertex-agent-sample-id"] = "financial-advisor"
